...
<body>
    <div class="header-text">
        <h1 style="font-family: open sans; font-weight: bold; font-size: 4rem">KLINIK</h1>
    </div>
    <div class="gambar">
    ...
    <div class="container">
        <div class="wrapper">
            <div class="form-container">
                <div class="slide-controls" style="font-weight: 900;">
                    <input type="radio" name="slide" id="login" checked>
                    <input type="radio" name="slide" id="signup">
                    <label for="login" class="slide login" style="font-weight: 900; font-size: 2.5rem;">Login</label>
                    <label for="signup" class="slide signup" style="font-weight: 900; font-size: 2.5rem;">Register</label>
                ...
                <div class="form-inner">
                    ...
                    <form action="{{ route('login') }}" class="login active" method="POST">
                        ...
                        <div class="signup-link" style="font-size: 2rem">
