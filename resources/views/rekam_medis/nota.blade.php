    ...
    <div class="container">
        <div class="nota">
            ...
            <div class="wrap">
                <div class="wrap-title">
                    ...
                    <p><strong>Tanggal Transaksi:</strong> {{ \Carbon\Carbon::parse($rekamMedis->kunjungan->update_at)->format('d-m-Y H:i') }}</p>
                </div>
        ...
        <div class="">
            @if (auth()->user()->hasRole('admin|dokter'))
                <a href="{{ route('kunjungan.index', $rekamMedis->kunjungan->id) }}" class="btn-close"
